module IndicatorBinance
  ...
  class Sma < Indicator
    ...
    def self.double_calculate(data = [], small_period = 5, big_period = 10)
      sma_small = calculate(data: data, period: small_period)
      sma_big   = calculate(data: data, period: big_period)
